...
import { YouMayKnow } from "@/components/user/components/you-may-know/YouMayKnow";
...
import {
  getUser,
  getUsers,
} from "@/components/user/services/server/get-user.server";
import {
  getAllTweets,
  getFeed,
  getUserFeed,
} from "@/components/tweet/services/server/get-tweet.server";
...
import { useOnScreen } from "@/participated/hooks/useOnScreen";
import { useCustomState } from "@/participated/hooks/useCustomState";
import useSwr from "swr";
import { fetcher } from "@/participated/libs/fetcher";
              ...
              <div ref={parent}>
                ...
                {isLastPage.value ? (
                  <div
                    ...
                    style={{ padding: "1rem", color: "var(--grey)" }}
                  >
                    no more tweets
                  </div>
                ) : (
